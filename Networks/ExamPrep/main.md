...
- мосты --- устройства, служащие для объединения сетей с разными стандартами обмена.
  Если подключить к мосту одинаковые сети, то работает как и коммутатор;
...
- шлюзы --- это устройство для соединения сетей с сильно отличающимися протоколами,
...
- Облачные вычисления (cloud computing) --- концепция в соответствии с которой
  ...
  Свойства:
  1. Качественно новый уровень разделения ресурсов;
  2. Высокая степень масштабируемости;
  3. Эластичность;
  4. Гибкость оплаты использованных ресурсов;
  5. Самостоятельное выделение ресурсов.
...
командных строк и получения необходимых данных через надёжный канал (TCP-
соединение).
...
- **Обновление**
  Сервер удаляет выбранные письма и закрываеhttps://www.mvideo.ru/komputernye-aksessuary-24/komputernye-kolonki-182 т соединени
